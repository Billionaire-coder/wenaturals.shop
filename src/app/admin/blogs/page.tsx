...
export default function BlogsPage() {
    ...
    const fetchBlogs = async () => {
        ...
        if (error) {
            ...
            const mappedBlogs = (data as unknown as BlogQueryResult[]).map((blog) => ({
                ...blog,
                excerpt: blog.excerpt || (typeof blog.content === 'string' ? blog.content.substring(0, 100).replace(/<[^>]*>?/gm, "") : "") + "...", // Auto-excerpt fallback
    ...
    return (
        <div className="space-y-8">
            ...
            <BlogForm
                ...
                initialData={editingBlog as unknown as Record<string, unknown>}
            />
        </div>
    );
}
