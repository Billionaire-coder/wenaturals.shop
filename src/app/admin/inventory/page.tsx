...
export default function InventoryPage() {
    ...
    const [editingCategory, setEditingCategory] = useState<{ name: string } | null>(null);
    ...
    const handleDeleteCategory = async (name: string) => {
        ...
        if (confirm(`Deleting this category will leave ${count} products uncategorized. Proceed?`)) {
    ...
    return (
        <div className="space-y-8">
            ...
            <ProductForm
                ...
                initialData={editingProduct as unknown as ProductData}
