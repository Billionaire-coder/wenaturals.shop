...
export default function FAQPage() {
    const faqContent = (useContent<{ faq: { title: string; description: string; items: { question: string; answer: string }[] } }>('content_pages'))?.faq || {};
    const [openIndex, setOpenIndex] = useState<number | null>(0);

    const items = faqContent.items || [];

    return (
        <main className="min-h-screen bg-zinc-50 dark:bg-[#050505] text-zinc-900 dark:text-white selection:bg-blue-500/30">
