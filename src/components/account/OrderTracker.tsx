        ...
        <div className="w-full space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 justify-between">
                <div className="flex flex-col">
                    ...
                    <span className="text-sm font-bold text-zinc-900 dark:text-white capitalize">{status.replace(/_/g, ' ')}</span>
                </div>
                {getPaymentBadge()}
            </div>
                            ...
                            <div key={step.id} className="flex flex-col items-center gap-3">
                                <motion.div
                                    ...
                                    className={cn(
                                        ...
                                        isCompleted ? "text-white" : "text-zinc-400 dark:text-zinc-600"
                                    )}
                                >
