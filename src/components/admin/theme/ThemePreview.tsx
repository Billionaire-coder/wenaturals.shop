...
export const ThemePreview = memo(forwardRef<HTMLIFrameElement, ThemePreviewProps>(({ activeView, previewMode, refreshKey }, ref) => {
    const iframeRef = useRef<HTMLIFrameElement>(null);

    // Expose the internal iframeRef to the parent
