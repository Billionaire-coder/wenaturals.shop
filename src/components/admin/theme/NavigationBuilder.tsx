...
export const NavigationBuilder = memo(({ activeTab }: NavigationBuilderProps) => {
    ...
    const globalContent = cmsData.content_global || {};
    const navbar = globalContent.navbar || {};
                    ...
                    <div className="space-y-4">
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                onChange={(e) => updateField('content_global', 'navbar', { ...navbar, logo_url: e.target.value })}
                        ...
                        <div className="space-y-3">
                            ...
                            {(navbar.links || []).map((link: { label: string; href: string; visible?: boolean }, i: number) => (
                                <div key={i} className="grid grid-cols-[1fr_1fr_auto] gap-2 items-center">
                                    <input
                                        ...
                                        onChange={(e) => {
                                            ...
                                            updateField('content_global', 'navbar', { ...navbar, links: newLinks });
                                        }}
                ...
                <>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            {(cmsData.content_navigation?.header || []).map((item: { label: string; href: string }, i: number) => (
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            {(cmsData.content_navigation?.footer || []).map((item: { label: string; href: string }, i: number) => (
                                <div key={i} className="flex gap-2 items-center bg-zinc-900/30 p-2 rounded-lg border border-white/5">
                                    <span className="text-zinc-500 font-mono text-xs w-6">{i + 1}.</span>
                                    <input
                                        value={item.label}
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-1">
                            <div className="flex justify-between items-center px-1">
                                ...
                                <button
                                    onClick={() => deepUpdateField('content_global', 'footer', 'newsletter_visible', footer.newsletter_visible === false ? true : false)}
                                    className={cn("p-0.5 rounded transition-colors", footer.newsletter_visible !== false ? "text-blue-400" : "text-zinc-600")}
                                    title={footer.newsletter_visible !== false ? "Visible" : "Hidden"}
                                >
                                    {footer.newsletter_visible !== false ? <Eye className="w-3.5 h-3.5" /> : <EyeOff className="w-3.5 h-3.5" />}
                                </button>
                            </div>
                            <input
...
NavigationBuilder.displayName = 'NavigationBuilder';
