...
export const HomepageCanvasManager = memo(() => {
    ...
    const getSectionVisibility = (sectionKey: string) => {
        ...
        const sectionData = cmsData[contentKey] as Record<string, unknown> | undefined;
        return sectionData?.visible !== false;
    };
...
HomepageCanvasManager.displayName = 'HomepageCanvasManager';
