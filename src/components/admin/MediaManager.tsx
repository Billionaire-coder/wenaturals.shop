...
export function MediaManager({ media, onChange }: MediaManagerProps) {
    ...
    const openCloudinaryWidget = () => {
        ...
        const cloudinary = (window as unknown as { cloudinary: any }).cloudinary;
        if (!cloudinary) {
        ...
        const widget = cloudinary.createUploadWidget(
            ...
            (error: Error | null, result: { event: string; info: { resource_type: string; bytes: number; secure_url: string } }) => {
