...
import { BlockContent } from "@/types/cms";
...
const HeroBlock = ({ content }: { content: BlockContent }) => (
...
const RichTextBlock = ({ content }: { content: BlockContent }) => (
...
const ImageTextBlock = ({ content }: { content: BlockContent }) => (
...
const BundleBlock = ({ content }: { content: BlockContent }) => {
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-8 md:p-12 lg:p-16 flex flex-col justify-center space-y-8">
                        <div>
                            ...
                            <p className="text-zinc-400 text-lg leading-relaxed line-clamp-3" dangerouslySetInnerHTML={{ __html: product.description as string }} />
                        </div>
                        ...
                        {product.bundle_items && product.bundle_items.length > 0 && (
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    {product.bundle_items.map((item: { name: string; quantity: number }, idx: number) => (
...
export function BlockRenderer({ blocks }: { blocks: { type: string; id: string; content: BlockContent }[] }) {
