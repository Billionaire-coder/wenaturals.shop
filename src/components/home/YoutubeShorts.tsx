...
export function YoutubeShorts(props: { initialContent?: Record<string, unknown> }) {
    ...
    return (
        <section className="py-12 md:py-16 px-4 sm:px-6 relative overflow-hidden bg-background transition-colors duration-300">
            {/* Background Media */}
                        ...
                        {(() => {
                            ...
                            if (thumb) {
                                return (
                                    <Image
                                        src={thumb as string}
                                        alt={(s.title as string) || "YouTube Short Thumbnail"}
                                        fill
