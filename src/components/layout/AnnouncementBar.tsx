...
import { AnnouncementBarContent } from "@/types/cms";

export function AnnouncementBar() {
    const contentData = useContent<Record<string, unknown>>('content_marketing');
    const config = (contentData?.announcement_bar || {}) as AnnouncementBarContent;
    const { enabled, text, link, color, dismissible } = config;
