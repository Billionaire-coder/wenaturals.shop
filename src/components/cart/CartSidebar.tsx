                            ...
                            {items.length === 0 ? (
                                <div className="h-full flex flex-col items-center justify-center text-center space-y-6 py-20">
                                    <div className="relative">
                                        ...
                                        <ShoppingBag className="w-20 h-20 text-zinc-300 dark:text-zinc-700 relative z-10 mx-auto" />
                                    </div>
                                    <div className="space-y-2 relative z-10">
                                        <p className="text-xl font-bold text-zinc-900 dark:text-white">Your cart is empty</p>
                                        <p className="text-sm text-zinc-500 dark:text-zinc-400 max-w-[200px] mx-auto">
                                            Your ritual collection awaits its first addition.
                                        </p>
                                    </div>
                                    <Link
                                        href="/shop"
                                        onClick={toggleCart}
                                        className="inline-flex items-center justify-center px-8 py-3 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-full text-sm font-bold transition-all hover:scale-105 active:scale-95 shadow-lg relative z-10"
                                    >
                                        Start Collecting
                                    </Link>
                                </div>
